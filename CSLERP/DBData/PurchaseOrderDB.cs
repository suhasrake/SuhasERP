        ...
        public Boolean InsertPOHeaderAndDetail(poheader poh, List<podetail> PODetail)
        {
            ...
            try
            {
                ...
                updateSQL = "insert into POHeader " +
                    ...
                    "TermsAndCondition,Status,DocumentStatus,CreateTime,CreateUser,CommentStatus,SpecialNote,Comments,ForwarderList)" +
                    " values (" +
                    "'" + poh.DocumentID + "'," +
                    poh.TemporaryNo + "," +
        ...
        public List<poheader> ListPopiFilters2(string QueryData)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    popih.TemporaryNo = reader.GetInt32(0);
                    popih.TemporaryDate = reader.GetDateTime(1);
                    popih.PONo = reader.GetInt32(2);
                    popih.PODate = reader.GetDateTime(3);
                    popih.CustomerName = reader.GetString(4);
                    popih.ProductValueINR = reader.GetDouble(5);
