    ...
    class PurchaseReturnHeaderDB
    {
        ...
        public static List<purchasereturndetail> getPRDetail(purchasereturnheader prh)
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    prd.StoreLocationID = reader.GetString(16);
                    prd.StoreLocationName = reader.GetString(17);
        ...
        public Boolean validatePRHeader(purchasereturnheader prh)
        {
            ...
            try
            {
                ...
                if (prh.CustomerID.Trim().Length == 0 || prh.CustomerID == null)
                {
                    return false;
                }
                if (prh.MRNNo == 0)
                ...
                if (prh.Remarks.Trim().Length == 0 || prh.Remarks == null)
                {
                    return false;
                }
            }
