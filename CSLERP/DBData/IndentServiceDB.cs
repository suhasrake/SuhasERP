...
namespace CSLERP.DBData
{
    ...
    class IndentServiceDB
    {
        public List<indentserviceheader> getFilteredIndentServiceHeaders(string userList, int opt, string userCommentStatusString)
        {
            ...
            try
            {
                ...
                string query1 = "select RowID, DocumentID, DocumentName,TemporaryNo,TemporaryDate," +
                    " WORequestNo,WORequestDate,ReferenceInternalOrder,CustomerID,CustomerName,CurrencyID,CurrencyName,StartDate,TargetDate,PaymentTerms,PaymentMode," +
                    " ServiceValue,TaxAmount,TotalAmount,Remarks, " +
                   ...
                   " where DocumentID = 'INDENTSERVICE' and ((forwarduser='" + Login.userLoggedIn + "' and DocumentStatus between 2 and 98) " +
                ...
                string query2 = "select RowID, DocumentID, DocumentName,TemporaryNo,TemporaryDate," +
                    ...
                    " Status,DocumentStatus,CreateTime,CreateUser,ForwardUser,ApproveUser,CreatorName,ForwarderName,ApproverName ,CommentStatus,ForwarderList " +
                     " ,ExchangeRate,ServiceValueINR,TaxAmountINR,TotalAmountINR from ViewWORequestHeader" +
                   " where DocumentID = 'INDENTSERVICE' and ((createuser='" + Login.userLoggedIn + "'  and DocumentStatus between 2 and 98 ) " +
                ...
                string query3 = "select RowID, DocumentID, DocumentName,TemporaryNo,TemporaryDate," +
                    ...
                    " Status,DocumentStatus,CreateTime,CreateUser,ForwardUser,ApproveUser,CreatorName,ForwarderName,ApproverName,CommentStatus,ForwarderList  " +
                    " ,ExchangeRate,ServiceValueINR,TaxAmountINR,TotalAmountINR from ViewWORequestHeader" +
                   " where DocumentID = 'INDENTSERVICE' and ((createuser='" + Login.userLoggedIn + "'" +
                ...
                string query6 = "select RowID, DocumentID, DocumentName,TemporaryNo,TemporaryDate," +
                   ...
                   " Status,DocumentStatus,CreateTime,CreateUser,ForwardUser,ApproveUser,CreatorName,ForwarderName,ApproverName,CommentStatus,ForwarderList  " +
                   " ,ExchangeRate,ServiceValueINR,TaxAmountINR,TotalAmountINR from ViewWORequestHeader" +
                   " where DocumentID = 'INDENTSERVICE' and  DocumentStatus = 99 and status = 1  order by WORequestDate desc,DocumentID asc,WORequestNo desc";
        ...
        public List<indentserviceheader> getIndentServiceListView()
        {
            ...
            try
            {
                string query = "select WORequestNo,WORequestDate,CustomerID,CustomerName from ViewWORequestHeader" +
