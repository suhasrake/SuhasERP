        ...
        public List<SRM> getSRMdata()
        {
            ...
            try
            {
                string query = "SELECT a.StockItemID, a.RowID AS StockReferenceNo, a.InwardDocumentID AS DOCUMENTID, "+
                    ...
                    "a.StoreLocation AS STOREID,PresentStock,0 issuequantity, " +
                    "b.Name,(SELECT FYID FROM dbo.FinancialYear WHERE(IsCurrentFY = 1) "+
                    "AND(a.InwardDocumentDate BETWEEN StartDate AND EndDate)) AS FYID "+
                    "FROM  dbo.Stock AS a, stockitem b where StoreLocation = 'NVPSTORE'and a.StockItemID=b.StockItemID";
                ...
                while (reader.Read())
                {
                    ...
                    srm.issuequantity = reader.GetInt32(12);
