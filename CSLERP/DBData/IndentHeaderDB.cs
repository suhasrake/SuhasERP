...
namespace CSLERP.DBData
{
    ...
    class IndentHeaderDB
    {
        ...
        public static List<poheader> getPurchaseOrderHeader(indentheader poh)
        {
            poheader pod;
            ...
            {
                string query = "";
                string refindent = poh.DocumentID + "(" + poh.IndentNo + "" + Main.delimiter1 + "" + poh.IndentDate.ToString("yyyy-MM-dd") + ");";
                SqlConnection conn = new SqlConnection(Login.connString);
