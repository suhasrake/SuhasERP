...
namespace CSLERP.DBData
{
    ...
    class TermsAndConditionsDB
    {
            ...
            try
            {
                foreach (termsandconditions tco in TConditions)
                {
                    if (rows.Contains(tco.RowID))
                    {
                        ...
                        updateSQL = "update TermsAndCondition set ParagraphID='" + tco.ParagraphID + "', " +
                    ...
                    else
                    {
                        updateSQL = "insert into TermsAndCondition " +
                                       "(ParagraphID,ParagraphHeading,Detail) " +
                                "values (" + tco.ParagraphID + ",'" + tco.ParagraphHeading + "'," + "'" + tco.Details + "')";
        ...
        public static string getTCDetailsNew(int pid)
        {
            string TCDetails = "";
            try
            {
